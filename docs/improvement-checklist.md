...
export default function sitemap(): MetadataRoute.Sitemap {
  const posts = blogPosts.map((post) => ({
    url: `https://x10.stefanov.tech/blog/${post.slug}`,
  ...
  return [
    {
      url: 'https://x10.stefanov.tech',
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 1,
    },
    {
      url: 'https://x10.stefanov.tech/blog',
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.9,
    },
...
<rss version="2.0">
  <channel>
    ...
    <link>https://x10.stefanov.tech/blog</link>
    ...
    <item>
      ...
      <link>https://x10.stefanov.tech/blog/${post.slug}</link>
